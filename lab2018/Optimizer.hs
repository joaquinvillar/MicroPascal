...
reduce (Binary Plus (Var y) (IntLit 0)) = Var y
reduce (Binary Plus (IntLit 0) (Var y)) = Var y
reduce (Binary Plus (IntLit y) (IntLit 0)) = IntLit y
reduce (Binary Plus (IntLit 0) (IntLit y)) = IntLit y
...
reduce (Binary Div (IntLit 0) (IntLit y)) = IntLit 0
reduce (Binary Div (IntLit 0) (Var y)) = IntLit 0
...
reduceBasic (Binary Plus (Var y) (IntLit 0)) = Var y
reduceBasic (Binary Plus (IntLit 0) (Var y)) = Var y
reduceBasic (Binary Plus (IntLit y) (IntLit 0)) = IntLit y
reduceBasic (Binary Plus (IntLit 0) (IntLit y)) = IntLit y
...
reduceBasic (Binary Div (IntLit 0) (Var y)) = IntLit 0
reduceBasic (Binary Div (IntLit 0) (IntLit y)) = IntLit 0
